...
Class(function LinkedList() {
  ...
  a.push = function(b) {
    if (typeof b !== "object") {
      throw "LinkedList only accepts objects."
    }
    if (this.first === null) {
      b.__prev = b;
      b.__next = b;
...
Class(function Events(c) {
  ...
  this.events.subscribe = function(d, e) {
    HydraEvents._addEvent(d, e, c)
  };
  this.events.unsubscribe = function(d, e) {
    HydraEvents._removeEvent(d, e)
  };
...
Class(function Render() {
  ...
  this.stopRender = function(l) {
    var k = h.indexOf(l);
    if (k > -1) {
      h.splice(k, 1)
    }
  };
  this.addThreshold = function(k, l) {
    f = k;
    if (d.indexOf(l) == -1 && l) {
      d.push(l)
    }
  };
  this.removeThreshold = function(l) {
    if (l) {
      var k = d.indexOf(l);
      if (k > -1) {
        d.splice(k, 1)
...
Class(function Mobile() {
  ...
  if (Device.mobile) {
    ...
    function b() {
      if (e.os == "iOS" && e.browser == "Safari" && e.version > 7 && !e.allowScroll) {
...
D3.Class(function Light(a) {
  ...
  this.calculate = function() {
    this.direction.copyTo(this.normal);
    this.normal.normalize()
  }
});
D3.Class(function Material(q) {
  Inherit(this, Component);
  var m = this;
  var h, o;
  var d, p, i, g, b, j, l;
  ...
  function f() {
    Render.nextFrame(function() {
      if (m.object && m.object._scene && m.object._scene.light) {
        var r = m.object._scene.light;
        b = new Vector3();
        h = o.create("Light3D");
        h.size("100%").setZ(99999).bg("#000")
      }
    })
  }
  ...
  function a(s) {
    if (m.object._scene.fog) {
      var u = m.object._scene.fog;
      j.subVectors(s.camera.position, l);
      var v = j.length();
      if (v > u) {
        var r = (u * 2) - u;
        v -= u;
        var t = Utils.convertRange(v, 0, r, 0, 1);
        t = Utils.clamp(t, 0, 1);
        g = 1 - t;
        o.div.style.opacity = g
      } else {
        if (g < 1) {
  ...
  function e(r) {
    if (r.light && (h || m.material.applyLight)) {
      m.object.position.copyTo(b);
      b.normalize();
      var s = r.light;
      var t = Math.max(0, b.dot(b, s.normal));
      j.subVectors(s.position, l);
      var v = j.length();
      var w = Utils.convertRange(v, 0, s.radius, 0, 1);
      var u = (w + t) / 2;
      if (h) {
        h.div.style.opacity = Math.min(u, 1)
      } else {
        if (m.material.applyLight) {
          m.material.applyLight(Math.min(u, 1))
        }
      }
    }
  }
  this.set("visible", function(r) {
    c = r;
    if (r) {
      q.show()
    } else {
  ...
  this.render = function(r) {
    ...
    m.object.worldMatrix.extractPosition(l);
    a(r);
    e(r);
    if (D3.CSS3D) {
      var x = D3.translate("-50%", "-50%", r.cssDistance);
      var w = "perspective(" + r.cssDistance + "px)";
      var t = x + " " + m.object.viewMatrix.getCSS();
      if (Device.browser.ie) {
        o.matrix(w + t)
      } else {
        o.matrix(t)
      ...
      r.projection.copyTo(p);
      p.multiply(m.object.viewMatrix);
      i.set(0, 0, 0);
      p.transformVector(i);
      i.x = i.x / i.z * r.centerX;
      i.y = i.y / i.z * r.centerY;
      var v = 1 / (i.z / r.cssDistance);
      var s = m.object.rotation.z;
      d.setTRS(i.x, i.y, s, v, v);
      j.subVectors(r.camera.position, l);
      var u = j.length();
      q.setZ(~~(999999 - u)).matrix("translate(-50%, -50%) " + d.getCSS());
      if (i.z <= 0 && !q._meshHidden) {
        q._meshHidden = true;
        q.hide()
      } else {
        if (i.z > 0 && q._meshHidden) {
...
D3.Class(function Scene(k, e) {
  ...
  this.setProjection = function(o, p, n) {
    ...
    if (m) {
      m.div.style[Device.styles.vendor + "Perspective"] = l.cssDistance + "px";
      b.div.style[Device.styles.vendor + "TransformStyle"] = "preserve-3d"
    }
  };
...
Class(function CSSAnimation(a) {
  ...
  function f() {
    var s = CSS._read();
    var n = "/*" + m + "*/";
    var B = "@-" + Device.vendor + "-keyframes " + m + " {\n";
    var t = n + B;
    if (s.strpos(m)) {
      var v = s.split(n);
      s = s.replace(n + v[1] + n, "")
    ...
    for (var r = 0; r < d.length; r++) {
      ...
      for (z in A) {
        var q = A[z];
        if (typeof q !== "string" && z != "opacity" && z != "zIndex") {
          q += "px"
        }
        t += CSS._toCSS(z) + ": " + q + ";"
      }
...
Class(function Warp(i) {
  ...
  this.render = function(k) {
    ...
    i.div.style[Device.styles.vendor + "Transform"] = a(d.points, d.width, d.height)
  };
...
Class(function CSSTween(o, z, C, l, t, r, q) {
  var y = this;
  var g, s, F, D, E;
  var f, p, d, j, n;
  var u, x, b, m;
  ...
  function h() {
    var G = TweenManager.getAllTransforms(o);
    var I = [];
    for (var H in z) {
      if (TweenManager.checkTransform(H)) {
        G.use = true;
        G[H] = z[H];
        delete z[H]
      } else {
    ...
    if (G.use) {
      I.push(TweenManager.getTransformProperty())
    }
    j = G;
    u = I
  }
  ...
  function A() {
    ...
    d = TweenManager._dynamicPool.get();
    p = TweenManager._dynamicPool.get();
  ...
  function k() {
    ...
    j = p.copy();
    if (b) {
      s = TweenManager.tween(z, D, C, l, t, v, w)
    }
    if (x) {
      n = TweenManager.tween(j, d, C, l, t, (!b ? v : null), (!b ? w : null))
    }
  }
  ...
  function a() {
    if (!y.kill && o.div && u) {
      o._cssTween = y;
      o.div._transition = true;
      var I = "";
      var G = u.length;
      for (var H = 0; H < G; H++) {
        I += (I.length ? ", " : "") + u[H] + " " + C + "ms " + TweenManager.getEase(l) + " " + t + "ms"
      }
      setTimeout(function() {
        if (y.kill || !o || !o.div) {
          return false
        }
        o.div.style[Device.styles.vendorTransition] = I;
        o.css(z);
        o.transform(j);
        y.playing = true;
        o.div.__tweenCompleteInterval = setTimeout(function() {
          if (y.kill || !o || !o.div) {
            return false
          }
          v()
  ...
  function e() {
    ...
    clearTimeout(o.div.__tweenCompleteInterval);
    y.playing = false
  }
  ...
  function B() {
    if (g) {
      ...
      TweenManager._dynamicPool.put(d.clear());
      TweenManager._dynamicPool.put(p.clear());
  ...
  this.start = function(H, J, K, L, G, M, I) {
    o = H;
    z = J;
    C = K;
    l = L;
  ...
  this.stop = function() {
    if (y.playing) {
      o.div.style[Device.styles.vendor + "Transition"] = "";
      o.div._transition = false;
      y.kill = true;
      o._cssTween = null;
      if (f) {
        f.stop()
...
(function() {
  ...
  $.fn.stopTween = function() {
    ...
    this.div.style[Device.styles.vendorTransition] = "";
    return this
  }
})();
(function() {
